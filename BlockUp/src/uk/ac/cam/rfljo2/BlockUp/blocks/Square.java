...
public class Square extends Block {
	...
	public void regenerateCells() {
		Cell[] cells = this.getCells();
				...
				Cell d = new Cell(getPivotPoint().getCol() + 2,getPivotPoint().getRow() - 1,cells[1].getType());
				Cell e = new Cell(getPivotPoint().getCol() + 1,getPivotPoint().getRow(),cells[2].getType());
				Cell f = new Cell(getPivotPoint().getCol() + 2,getPivotPoint().getRow() - 1,cells[3].getType());
				cells[0] = c;
				cells[1] = d;
				cells[2] = e;
				cells[3] = f;
